...
public class AQArmorMaterials {
    ...
    public static final RegistryKey<EquipmentAsset> AQ_TURTLE_ARMOR_MATERIAL_KEY = RegistryKey.of(EquipmentAssetKeys.REGISTRY_KEY, Identifier.tryParse(AQ.MOD_ID, "aq_turtle"));
    ...
    public static final TagKey<Item> REPAIRS_TURTLE_INGO = AQItems.TURTLE_INGOT.asItem();
    public static final RegistryKey<EquipmentAsset> AQ_TURTLE_ARMOR_MATERIAL_KEY = RegistryKey.of(EquipmentAssetKeys.REGISTRY_KEY, Identifier.tryParse(AQ.MOD_ID, "aq_turtle"));
