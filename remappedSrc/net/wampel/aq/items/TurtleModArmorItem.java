...
public class TurtleModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.TURTLE,
                            new StatusEffectInstance(StatusEffects.CONDUIT_POWER, 5*20, 0, false, false, false)).build();

    public TurtleModArmorItem(ArmorMaterial material, Type slot, Settings settings) {
